...
public:
  ...
  void initCamera( ){
    camera = Camera(glm::vec3(0.0, 0.0, 5.0), glm::vec3(0.0, 1.0, 0.0), glm::vec3(0.0, 0.0, 0.0));
  }
  /*
  ...
  */
  ...
  bool render( ){
    ...
    glm::mat4 lookAtMatrix = glm::lookAt(camera.eyePosition, camera.lookAt, camera.upVector);
